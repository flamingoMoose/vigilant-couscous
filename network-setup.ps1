...
Write-Host "Waiting for basic container startup (30 seconds)..."
Start-Sleep -Seconds 30

# Verify orderers are running
Write-Host "Verifying orderer containers are running..."
...
Write-Host "Giving orderers more time to stabilize and elect a leader (60 seconds)..."
...
Write-Host "Waiting for channel creation to complete (15 seconds)..."
...
Write-Host "`nNetwork setup complete with RAFT consensus!"